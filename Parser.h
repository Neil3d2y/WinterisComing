...
#ifndef TINYSQL_PARSER_H
#define TINYSQL_PARSER_H
...
/**
 *
 * Break the a qury in String to a list of shorted string
 * Number, KeyWord
 *
 */
class Tokens
...
/**
 *
 * Each node is still store the value in String
 *
 */
class ParseTreeNode
{
